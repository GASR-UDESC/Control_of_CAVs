...
r = robotarium.Robotarium(number_of_robots=N, show_figure=True, initial_conditions=initial_points,
        ...
        if real_state[i] == logical_state[i] or first_iteration[i]:
            ...
            if logical_transition[i] in blacklist:
                ...
                try:
                    ...
                    (momentaneous_blocked, new_goal) = rc.check_momentaneous_block(G_whitelist, real_state[i],
                                                                                   blacklist)
