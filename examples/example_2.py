...
Final_pos = [Matrix_states[0][2],Matrix_states[0][1]]
...
gt_img = plt.imread('Control_of_CAVs/map.jpg')
x_img = np.linspace(-1.0, 1.0, gt_img.shape[1])
y_img = np.linspace(-1.0, 1.0, gt_img.shape[0])
scale_img = 1.1
gt_img_handle = r.axes.imshow(gt_img, extent=(scale_img*positions[0][0][0], scale_img*positions[-1][-1][0], -scale_img*positions[0][0][1], -scale_img*positions[-1][-1][1]))#"""
