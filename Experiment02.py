...
def EXPERIMENT02():
    ...
    #Experiment 2 - Lane swap
    Initial_pos = ([Matrix_states[0][0]]+[Matrix_states[1][0]]+[Matrix_states[2][0]]+[Matrix_states[3][0]]+[Matrix_states[4][0]])
    Final_pos = ([Matrix_states[4][4]]+[Matrix_states[3][4]]+[Matrix_states[2][4]]+[Matrix_states[1][4]]+[Matrix_states[0][4]])
